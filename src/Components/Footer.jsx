...
const Footer = () => {
  return (
    <footer className="px-4 divide-y bg-gray-800 text-gray-100">
      <div className="container flex flex-col lg:max-w-[1140px] justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          <Link className="flex justify-center space-x-3 lg:justify-start">
            <span className="self-center text-2xl font-semibold">Elite States</span>
          </Link>
        </div>
      ...
      <div className="py-6 text-sm text-center text-gray-400">© 2024 Elite States Co. All rights reserved.</div>
    </footer>
  );
};
